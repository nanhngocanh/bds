...
<div class="container mt-3">
    ...
    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
        ...
        <div class="my-3">
            ...
            <input type="text" name="fullname" placeholder="EX: Hoang Xuan Bach" class="form-control" required value="{{ old('fullname') }}">
        </div>

        <div class="mb-3">
            <label for="email" class="form-label">Email: </label>
            <input type="email" name="email" placeholder="EX: aaa@gmail.com" class="form-control" required value="{{ old('email') }}">
        </div>

        <div class="mb-3">
            <label for="phone" class="form-label">Phone: </label>
            <input type="text" name="phone" placeholder="EX: 12321434" class="form-control" required value="{{ old('phone') }}">
        </div>
