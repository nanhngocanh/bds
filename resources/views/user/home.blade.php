...
<html lang="en">
  ...
  <body>
    <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0">
      <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="#">User page</a>
      <input class="form-control form-control-dark w-100" type="text" placeholder="Search" aria-label="Search">\
      <a class="d-flex align-items-center text-muted" href="{{route('bookmark')}}">
        <span data-feather="heart" style="margin: 10px 10px 10px 10px"></span>
      </a>
      <a class="d-flex align-items-center text-muted" href="{{route('message')}}">
        ...
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
          <div class="sidebar-sticky">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link" href="{{ route("bookmark") }}">
